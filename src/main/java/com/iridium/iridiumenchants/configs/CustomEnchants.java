...
public class CustomEnchants {
    public Map<String, CustomEnchant> customEnchants = ImmutableMap.<String, CustomEnchant>builder()
            ...
            .put("Poison", new CustomEnchant("&7Poison", "Gives your opponent poison effect", Type.SWORD, "PLAYER_DAMAGE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("POTION:POISON:1:5:TARGET")))
                    .put(2, new Level(100, Collections.singletonList("POTION:POISON:2:5:TARGET")))
                    .put(3, new Level(100, Collections.singletonList("POTION:POISON:3:5:TARGET")))
                    .build(), true))
            .put("Wither", new CustomEnchant("&7Wither", "Gives your opponent wither effect", Type.AXE, "PLAYER_DAMAGE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("POTION:WITHER:1:5:TARGET")))
                    .put(2, new Level(100, Collections.singletonList("POTION:WITHER:2:5:TARGET")))
                    .put(3, new Level(100, Collections.singletonList("POTION:WITHER:3:5:TARGET")))
                    .build(), true))
