...
public class CustomEnchants {
    public Map<String, CustomEnchant> customEnchants = ImmutableMap.<String, CustomEnchant>builder()
            ...
            .put("Renewal", new CustomEnchant("&7Renewal", "Upon killing a player you receive regeneration for 5 seconds", Type.SWORD, "PLAYER_KILL", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("POTION:REGENERATION:1:5")))
                    .put(2, new Level(10, Collections.singletonList("POTION:REGENERATION:2:5")))
                    .put(3, new Level(10, Collections.singletonList("POTION:REGENERATION:3:5")))
                    .build(), true))
            ...
            .put("Grace", new CustomEnchant("&7Grace", "Gives your allies regeneration upon your death", Type.CHESTPLATE, "PLAYER_DEATH", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:1:5:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:2:5:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:3:5:TARGET")))
                    .build(), true))
            .build();
}
