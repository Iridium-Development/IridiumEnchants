...
public class CustomEnchants {
    public Map<String, CustomEnchant> customEnchants = ImmutableMap.<String, CustomEnchant>builder()
            ...
            .put("Poison", new CustomEnchant("&7Poison", "Gives your opponent poison effect", Type.SWORD, "PLAYER_DAMAGE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("POTION:POISON:1:5:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("POTION:POISON:2:5:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("POTION:POISON:3:5:TARGET")))
                    .build(), true))
            .put("Wither", new CustomEnchant("&7Wither", "Gives your opponent wither effect", Type.AXE, "PLAYER_DAMAGE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("POTION:WITHER:1:5:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("POTION:WITHER:2:5:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("POTION:WITHER:3:5:TARGET")))
                    .build(), true))
            .put("Ignition", new CustomEnchant("&7Ignition", "Sets your attacker on fire", Type.CHESTPLATE, "DEFENCE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("FIRE:40:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("FIRE:80:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("FIRE:100:TARGET")))
                    .build(), true))
            .put("Slowness", new CustomEnchant("&7Slowness", "Gives your opponent a slowness effect", Type.BOW, "PLAYER_DAMAGE_PROJECTILE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("POTION:SLOW:1:5:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("POTION:SLOW:2:5:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("POTION:SLOW:3:5:TARGET")))
                    .build(), true))
            .put("Blindness", new CustomEnchant("&7Blindness", "Gives your opponent a blindness effect", Type.BOW, "PLAYER_DAMAGE_PROJECTILE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("POTION:BLINDNESS:1:5:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("POTION:BLINDNESS:2:5:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("POTION:BLINDNESS:3:5:TARGET")))
                    .build(), true))
            .put("Explosive", new CustomEnchant("&7Explosive", "Chance for your arrows to explode on impact", Type.BOW, "PLAYER_DAMAGE_PROJECTILE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("EXPLODE:1:FALSE:FALSE:TARGET")))
                    .put(2, new Level(10, Collections.singletonList("EXPLODE:2:FALSE:FALSE:TARGET")))
                    .put(3, new Level(10, Collections.singletonList("EXPLODE:3:FALSE:FALSE:TARGET")))
                    .build(), true))
            ...
            .put("Cursed", new CustomEnchant("&7Cursed", "Gives all enemies in a radius of 10 Slowness", Type.CHESTPLATE, "PASSIVE:20", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("AURA:ENEMY:10:POTION:SLOW:1:5:TARGET")))
                    .put(2, new Level(100, Collections.singletonList("AURA:ENEMY:10:POTION:SLOW:2:5:TARGET")))
                    .put(3, new Level(100, Collections.singletonList("AURA:ENEMY:10:POTION:SLOW:3:5:TARGET")))
                    .build(), true))
            .put("Leader", new CustomEnchant("&7Leader", "Gives all allies in a radius of 10 Strength", Type.CHESTPLATE, "PASSIVE:20", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:INCREASE_DAMAGE:1:5:TARGET")))
                    .put(2, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:INCREASE_DAMAGE:2:5:TARGET")))
                    .put(3, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:INCREASE_DAMAGE:3:5:TARGET")))
                    .build(), true))
            .put("Holy", new CustomEnchant("&7Holy", "Gives all allies in a radius of 10 Regeneration", Type.CHESTPLATE, "PASSIVE:20", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:1:1:TARGET")))
                    .put(2, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:1:3:TARGET")))
                    .put(3, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:1:5:TARGET")))
                    .build(), true))
            .put("Berserk", new CustomEnchant("&7Berserk", "Gives all enemies in a radius of 10 Wither", Type.AXE, "PLAYER_DAMAGE", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("AURA:ENEMY:10:POTION:WITHER:1:5:TARGET")))
            ...
            .put("Renewal", new CustomEnchant("&7Renewal", "Upon killing a player you receive regeneration for 5 seconds", Type.SWORD, "PLAYER_KILL", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("POTION:REGENERATION:1:5")))
                    .put(2, new Level(100, Collections.singletonList("POTION:REGENERATION:2:5")))
                    .put(3, new Level(100, Collections.singletonList("POTION:REGENERATION:3:5")))
                    .build(), true))
            .put("Inquisitive", new CustomEnchant("&7Inquisitive", "Gives you extra experience upon killing a mob", Type.AXE, "ENTITY_KILL", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(10, Collections.singletonList("EXPERIENCE:3")))
                    .put(2, new Level(10, Collections.singletonList("EXPERIENCE:6")))
                    .put(3, new Level(10, Collections.singletonList("EXPERIENCE:10")))
                    .build(), true))
            .put("Grace", new CustomEnchant("&7Grace", "Gives your allies regeneration upon your death", Type.CHESTPLATE, "PLAYER_DEATH", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("AURA:ALLY:10:POTION:REGENERATION:1:5:TARGET")))
