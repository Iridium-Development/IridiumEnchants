...
public class CustomEnchants {
    public Map<String, CustomEnchant> customEnchants = ImmutableMap.<String, CustomEnchant>builder()
            ...
            .put("Jacket", new CustomEnchant("&7Jacket", "Gives you an unlimited absorbtion effect", Type.LEGGINGS, "PASSIVE:20", ImmutableMap.<Integer, Level>builder()
                    .put(1, new Level(100, Collections.singletonList("Common"), Collections.singletonList("POTION:ABSORPTION:1:5")))
                    .put(2, new Level(100, Collections.singletonList("Elite"), Collections.singletonList("POTION:ABSORPTION:2:5")))
                    .put(3, new Level(100, Collections.singletonList("Legendary"), Collections.singletonList("POTION:ABSORPTION:3:5")))
                    .build(), true))
